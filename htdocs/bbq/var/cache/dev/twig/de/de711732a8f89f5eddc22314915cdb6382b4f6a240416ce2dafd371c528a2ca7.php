...
/* user/show.html.twig */
class __TwigTemplate_ac3bfe54c9097883647d3d9cbbfffebf3cbcd11deb2249989ed70bc839ec7c3d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 24, $this->source); })()), "ceQueJeRamene", [], "any", false, false, false, 24), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "/shared/httpd/bbq/htdocs/bbq/templates/user/show.html.twig");
    }
}
